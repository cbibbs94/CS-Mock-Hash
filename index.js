...
checkPassword = async (username, plaintextPassword) => {
    ...
    if (globalStore[username]) {
        ...
        if (result) {
            ...
            console.log(`Access Granted Identity Confirmed As ${username}`)
        }
        else {
            // TODO: Display message for invalid credentials
            console.log('You gotta bounce bruh, You do not belong here!')
        }
    }
    else {
...
hashPassword = async (username, password) => {
    ...
    console.log(`Dope! User '${username}' has been added! Password is ${hashedPassword}\n`)
}
